"use strict";
(self["webpackChunkmydayapp_js"] = self["webpackChunkmydayapp_js"] || []).push([[376,412],{
...
__webpack_require__.d(__webpack_exports__, {
  "addTodoList": () => (/* binding */ addTodoList)
});

// EXTERNAL MODULE: ./src/js/data/Tasks.js
var Tasks = __webpack_require__(412);
;// CONCATENATED MODULE: ./src/js/logic/idGenerator.js

var incrementer = function incrementer() {
  var counter = 0;
  return function () {
    var lastId = Tasks.taskPlanner.getLastTaskId();
    counter = lastId ? lastId : 0;
    counter++;
    return counter;
  };
};
var idGenerator = incrementer();
;// CONCATENATED MODULE: ./src/js/UI/AddTodoList.js

var addTodoList = function addTodoList(text) {
  var id = idGenerator();
  var newTask = {
    id: id,
    title: text,
  ...
  Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 412)).then(function (module) {
    return module.taskPlanner.addTask(newTask);
  });
